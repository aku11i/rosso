...
test('aggregateFeedItems keeps duplicate links across different feeds', () => {
  const items = aggregateFeedItems([
    {
      title: null,
      description: null,
...
test('aggregateFeedItems throws on invalid timestamps', () => {
  assert.throws(
    () =>
      aggregateFeedItems([
        {
